...
function Calendar() {
    ...
    return (<table className="table-fixed w-full border border-gray-300 [&_td]:px-2 [&_td]:py-4">
        <tbody>
            <tr>
                {/* Auto-fit column with right border separator */}
                <td className="align-top w-1/6 whitespace-nowrap border-r border-gray-300">
